// This code was autogenerated with `dbus-codegen-rust --system-bus --generic-variant --methodtype None --destination org.freedesktop.UPower --skipprefix org.freedesktop --path /org/freedesktop/UPower/devices/DisplayDevice`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
use dbus::arg;
use dbus::blocking;
